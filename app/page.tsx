...
export default function Home() {
  ...
  return (
    <>
<section
  className="bg-cover bg-center bg-no-repeat" style={{ backgroundImage: `url(${backgroundImage})` }}>
  ...
  >
    <div className="bg-white rounded p-8 max-w-xl text-left ltr:sm:text-left rtl:sm:text-right">
      ...
      Sabores únicos para
        <strong className="block font-extrabold text-rose-700"> Momentos especiales. </strong>
      </h1>
